...
if (!class_exists('ofttCommon')) {
	...
	class ofttCommon {
        ...
        public static function plugin_text_domain() {
            ...
            return 'options-for-twenty-twenty';
        ...
        public static function support_url() {
            ...
            return 'https://wordpress.org/support/plugin/' . 'options-for-twenty-twenty' . '/';
...
/* translators: name of the plugin */
            $upgrade_text = '<a href="' . esc_url(self::upgrade_link()) . '" title="' . esc_attr(sprintf(__('Upgrade now to %s Premium', 'options-for-twenty-twenty'), self::$plugin_name)) . '">' . sprintf(__('Upgrade now to %s Premium', 'options-for-twenty-twenty'), self::$plugin_name) . '</a>';
...
/* translators: link to the premium upgrade */
                    $upgrade_text .= sprintf(wp_kses(__(' or <a href="%s" title="Download Free Trial">trial it for 7 days</a>', 'options-for-twenty-twenty'), array('a' => array('href' => array(), 'title' => array()))), esc_url(self::premium_link()));
...
/* translators: link to the plugin's support forum */
            $default_description = sprintf(wp_kses(__('If you have any requests for new features, please <a href="%s" title="Support Forum">let us know in the support forum</a>.', 'options-for-twenty-twenty'), array('a' => array('href' => array(), 'title' => array()))), esc_url(self::support_url()));
            ...
            if (self::$plugin_premium_class) {
                ...
                if (!class_exists(self::$plugin_premium_class) || !get_option(self::$plugin_prefix . '_purchased')) {
                    ...
                    if (!class_exists(self::$plugin_premium_class)) {
                        ...
                        $section_description = '<strong>' . __('For even more options', 'options-for-twenty-twenty') . '</strong>' . ' ' . $upgrade_text;

                    } else {

                        $section_description = '<strong>' . __('To keep using premium options', 'options-for-twenty-twenty') . '</strong>' . ' ' . $upgrade_text;
...
/* translators: link to plugin install page */
        ...
        public static function control_setting_upgrade_nag() {
            ...
            $upgrade_nag = self::control_upgrade_text() . __(' to use this option.', 'options-for-twenty-twenty');
...
// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        ...
        public static function upgrade_link() {
            ...
            if (self::$plugin_premium_class) {
                ...
                if (isset($_SERVER['HTTP_HOST'])) {
                    ...
                    return add_query_arg('url', (isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . filter_var(wp_unslash($_SERVER['HTTP_HOST'], FILTER_SANITIZE_URL)), 'https://webd.uk/product/' . 'options-for-twenty-twenty' . '-upgrade/');

                } else {

                    return 'https://webd.uk/product/' . 'options-for-twenty-twenty' . '-upgrade/';
        ...
        public static function plugin_action_links($settings_link, $premium = false) {
			...
			$settings_links[] = '<a href="' . esc_url($settings_link) . '" title="' . esc_attr(__('Settings', 'options-for-twenty-twenty')) . '">' . __('Settings', 'options-for-twenty-twenty') . '</a>';
...
/* translators: name of the plugin */
                        $settings_links[] = '<a href="' . esc_url(self::upgrade_link()) . '" title="' . esc_attr(sprintf(__('Buy %s Premium', 'options-for-twenty-twenty'), self::$plugin_name)) . '" style="color: orange; font-weight: bold;">' . __('Buy Now', 'options-for-twenty-twenty') . '</a>';

                    } else {

/* translators: name of the plugin */
                        $settings_links[] = '<a href="' . esc_url(self::upgrade_link()) . '" title="' . esc_attr(sprintf(__('Buy %s', 'options-for-twenty-twenty'), self::$plugin_name)) . '" style="color: orange; font-weight: bold;">' . __('Buy Now', 'options-for-twenty-twenty') . '</a>';
...
/* translators: name of the plugin */
                    $settings_links[] = '<a href="' . esc_url(self::upgrade_link()) . '" title="' . esc_attr((self::$plugin_premium_class ? sprintf(__('Upgrade now to %s Premium', 'options-for-twenty-twenty'), self::$plugin_name) : sprintf(__('Contribute to %s', 'options-for-twenty-twenty'), self::$plugin_name))) . '" style="color: orange; font-weight: bold;">' . (self::$plugin_premium_class ? __('Upgrade', 'options-for-twenty-twenty') : __('Support Us', 'options-for-twenty-twenty')) . '</a>';

                }

                if ($premium) {

                    $settings_links[] = '<a href="' . wp_nonce_url('?activate-' . self::$plugin_prefix . '=true', self::$plugin_prefix . '_activate') . '" id="' . self::$plugin_prefix . '_activate_upgrade" title="' . esc_attr(__('Activate Purchase', 'options-for-twenty-twenty')) . '" onclick="jQuery(this).append(&#39; <img src=&#34;/wp-admin/images/loading.gif&#34; style=&#34;float: none; width: auto; height: auto;&#34; />&#39;); setTimeout(function(){document.getElementById(\'' . self::$plugin_prefix . '_activate_upgrade\').removeAttribute(\'href\');},1); return true;">' . __('Activate Purchase', 'options-for-twenty-twenty') . '</a>';

                } elseif (self::$plugin_trial && !is_plugin_active('options-for-twenty-twenty' . '-premium/' . 'options-for-twenty-twenty' . '-premium.php')) {

/* translators: name of the plugin */
                    $settings_links[] = '<a href="' . esc_url(self::premium_link()) . '" title="' . esc_attr(sprintf(__('Trial %s Premium', 'options-for-twenty-twenty'), self::$plugin_name)) . ' for 7 days">' . __('Download Trial', 'options-for-twenty-twenty') . '</a>';

                }

            } elseif ($premium) {

                $settings_links[] = '<strong style="color: green; display: inline;">' . __('Purchase Confirmed', 'options-for-twenty-twenty') . '</strong>';
        ...
        public static function plugin_row_meta($plugin_meta, $plugin_file, $plugin_data, $status) {
            ...
            if ($plugin_file === 'options-for-twenty-twenty' . '/' . 'options-for-twenty-twenty' . '.php') {

                $plugin_meta[] = '<a href="' . esc_url(self::support_url()) . '" title="' . __('Problems? We are here to help!', 'options-for-twenty-twenty') . '" style="color: orange; font-weight: bold;">' . __('Need help?', 'options-for-twenty-twenty') . '</a>';
/* translators: name of the plugin */
                $plugin_meta[] = '<a href="https://wordpress.org/support/plugin/' . 'options-for-twenty-twenty' . '/reviews/#new-post" title="' . esc_attr(sprintf(__('If you like %s, please leave a review!', 'options-for-twenty-twenty'), self::$plugin_name)) . '">' . __('Review plugin', 'options-for-twenty-twenty') . '</a>';
...
<?php esc_html_e('In order to use the premium features, you need to install the premium version of the plugin ...', 'options-for-twenty-twenty'); ?></p>

<p><a href="<?php
/* translators: name of the plugin */
echo esc_url(self::premium_link()); ?>" title="<?php echo esc_attr(sprintf(__('Download %s Premium', 'options-for-twenty-twenty'), self::$plugin_name)); ?>" class="button-primary"><?php printf(esc_html(__('Download %s Premium', 'options-for-twenty-twenty')), esc_html(self::$plugin_name)); ?></a></p>
...
/* translators: name of the plugin */
printf(esc_html(__('Thank you for using %s plugin', 'options-for-twenty-twenty')), esc_html(self::$plugin_name)); ?></strong></p>
<?php
...
?>
    ...
    <p><?php echo esc_html(__('Would you like to try even more features? Download your 7 day free trial now!', 'options-for-twenty-twenty')); ?></p>
<?php
...
?>
    ...
    <p>
        <?php
/* translators: name of the plugin */
                        echo esc_html(sprintf(__('Upgrade now to %s Premium to enable more options and features and contribute to the further development of this plugin.', 'options-for-twenty-twenty'), self::$plugin_name)); ?>
    </p>
<?php
...
?>
        ...
        <a href="<?php echo esc_url(self::premium_link()); ?>" 
           title="<?php
/* translators: name of the plugin */
echo esc_attr(sprintf(__('Try %s Premium', 'options-for-twenty-twenty'), self::$plugin_name)); ?>" 
           class="button-secondary">
           <?php echo esc_html(__('Try premium plugin free for 7 days', 'options-for-twenty-twenty')); ?>
        </a>
<?php
...
?>
        ...
        <a href="<?php echo esc_url(self::upgrade_link()); ?>" 
           title="<?php
/* translators: name of the plugin */
echo esc_attr(sprintf(__('Upgrade now to %s Premium', 'options-for-twenty-twenty'), self::$plugin_name)); ?>" 
           class="button-primary">
           <?php echo esc_html(__('Upgrade now to premium plugin', 'options-for-twenty-twenty')); ?>
        </a>
    ...
    <p>
        ...
        <a href="https://webd.uk/services/?utm_campaign=notice&utm_term=options-for-twenty-twenty" class="button-secondary" style="margin-left:6px; vertical-align: middle;">Explore our services</a>
    </p>
...
?>
    ...
    <p><?php esc_html_e('Funding plugins like this one with small financial contributions is essential to pay the developers to continue to do what they do. Please take a moment to give a small amount ...', 'options-for-twenty-twenty'); ?></p>

    <p><a href="<?php echo esc_url(self::upgrade_link()); ?>" title="<?php
/* translators: name of the plugin */
echo esc_attr(sprintf(__('Contribute to %s', 'options-for-twenty-twenty'), self::$plugin_name)); ?>" class="button-primary"><?php echo esc_html(__('Buy us a coffee ☕️', 'options-for-twenty-twenty')); ?></a> <a href="#" id="<?php echo esc_attr(self::$plugin_prefix); ?>-already-paid" title="<?php echo esc_attr(__('Aleady Contributed!', 'options-for-twenty-twenty')); ?>" class="button-secondary"><?php esc_html_e('Aleady Contributed!', 'options-for-twenty-twenty'); ?></a></p>
...
<script type="text/javascript">
    jQuery(document).on('click', '#<?php echo esc_attr(self::$plugin_prefix); ?>-already-paid', function() {
        if (confirm(<?php echo json_encode(__('Have you really? Press "Cancel" if you forgot to 🙂', 'options-for-twenty-twenty')); ?>)) {
            alert(<?php echo json_encode(__('Thank you!', 'options-for-twenty-twenty')); ?>);
